...
public:
	...
	SimpleAudioEngine* alarm = SimpleAudioEngine::getInstance();
	SimpleAudioEngine* bel = SimpleAudioEngine::getInstance();
	SimpleAudioEngine* voice = SimpleAudioEngine::getInstance();
