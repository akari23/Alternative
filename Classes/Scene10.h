...
public:
	...
	Sprite* lily_sprite = Sprite::create("character/lily/l1.png");
	///////////////////
	...
	//background latar//
	Sprite* background = Sprite::create("bg/kamar.jpg");
	///////////////////
	...
	Label* label_choose_left = Label::createWithTTF("Pergi ke gunung", "fonts/arial.ttf", 20);
	Label* label_choose_right = Label::createWithTTF("Tetap menolak pergi", "fonts/arial.ttf", 20);
	///////////////////////
