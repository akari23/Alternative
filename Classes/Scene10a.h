#ifndef __SCENE_10_a_H__
#define __SCENE_10_a_H__
...
public:
	...
	Sprite* naomi_sprite = Sprite::create("character/naomi/1.png");
	///////////////////
	...
	//background latar//
	Sprite* background = Sprite::create("bg/ruang_tengah_anna.jpg");
	///////////////////


	static Scene* scene();
	virtual bool init();
	CREATE_FUNC(Scene10a);
